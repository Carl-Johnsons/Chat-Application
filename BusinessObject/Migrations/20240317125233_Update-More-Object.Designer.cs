...
namespace BussinessObject.Migrations
{
    ...
    [Migration("20240317125233_Update-More-Object")]
    partial class UpdateMoreObject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BussinessObject.Models.IndividualConversation", b =>
                {
                    b.Property<int>("ConverastionId")
                        .HasColumnType("int")
                        .HasColumnName("ConverastionId");
                    ...
                    b.ToTable("IndividualConversation");
                });
            ...
            modelBuilder.Entity("BussinessObject.Models.GroupConversation", b =>
                {
                    b.HasOne("BussinessObject.Models.Conversation", "Converastion")
                        .WithMany()
                        .HasForeignKey("ConverastionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK__GroupConversation__Converastion");

                    b.Navigation("Converastion");
                });
            ...
            modelBuilder.Entity("BussinessObject.Models.IndividualConversation", b =>
                {
                    b.HasOne("BussinessObject.Models.Conversation", "Converastion")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK__IndividualConversation__Converastion");
