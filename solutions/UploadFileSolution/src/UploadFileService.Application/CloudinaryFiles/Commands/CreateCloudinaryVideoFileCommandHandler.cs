...
public record CreateCloudinaryVideoFileCommand : IRequest<CloudinaryFile?>
{
    [Required]
    public IFormFile FormFile { get; init; } = null!;
}
public class CreateCloudinaryVideoFileCommandHandler : IRequestHandler<CreateCloudinaryVideoFileCommand, CloudinaryFile?>
{
    private readonly IApplicationDbContext _context;
    private readonly IUnitOfWork _unitOfWork;
    private readonly Cloudinary _cloudinary;

    public CreateCloudinaryVideoFileCommandHandler(IApplicationDbContext context, IUnitOfWork unitOfWork, Cloudinary cloudinary)
    {
        _context = context;
    ...
    public async Task<CloudinaryFile?> Handle(CreateCloudinaryVideoFileCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            {
                throw new Exception("Invalid file (video), chosen file: " + Path.GetExtension(fileName));
            }
